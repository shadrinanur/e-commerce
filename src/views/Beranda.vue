<template>
    ...
    <div class="mb-20 mt-40 px-4 sm:max-w-xl md:max-w-full md:px-24 lg:ml-auto lg:max-w-screen-md lg:px-8">
      <div class="flex flex-col items-center justify-between lg:flex-row">
        <div class="max-w-xl text-center lg:max-w-lg lg:pr-5 lg:text-left">
          <h2 style="font-style: italic;" class="mb-6 max-w-lg text-3xl leading-snug tracking-tight text-blue-600 sm:text-5xl sm:leading-snug">
            <span class="my-1 inline-block font-serif font-bold text-purple-600">Welcome</span>
            to Scandiez Shopping Store
          </h2>
          <p style="font-family: ;" class="text-base text-purple-700">Happy Shopping !</p>
          <div class="mt-8 flex flex-col justify-center sm:flex-row sm:items-center sm:space-x-4 lg:justify-start">
            <button class="relative mt-4 rounded-lg border-2 border-indigo-500 bg-indigo-500 px-6 py-2 font-medium text-white transition hover:translate-y-1">
              <div class="absolute left-0 -bottom-12 hidden h-10 w-16 -rotate-12 -scale-x-100 text-purple-600 md:inline-flex">
          ...
          <a href="/Produk"> View Produk</a>
            </button>
            <button class="mt-4 flex items-center justify-center rounded-lg border-2 border-blue-600 px-6 py-2 font-medium text-blue-600 transition hover:translate-y-1 hover:bg-white">
              <svg xmlns="" class="mr-2 h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM9.555 7.168A1 1 0 008 8v4a1 1 0 001.555.832l3-2a1 1 0 000-1.664l-3-2z" clip-rule="evenodd" />
              </svg>
             <a href="/Merk">See More</a>
            </button>
          </div>
        </div>
      </div>
  ...
  <div class="basis-1/2 pt-10 mr-7">
    <img class="h-full w-full object-cover mt-9" src="../assets/iconbaru.png" alt=""  />
  </div>
</div> <br><br>
